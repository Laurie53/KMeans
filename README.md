L'objectif principal de ce projet est de proposer un clustering par la méthode des k-means en fonction de l'emplacement des stations vélos de la ville de Brisbane. 
